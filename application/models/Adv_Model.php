...
class Adv_Model extends CI_Model
{
  ...
  `customField1` varchar(250) DEFAULT NULL,
  `customField2` varchar(250) DEFAULT NULL,
  `customField3` varchar(250) DEFAULT NULL,
  `customField4` varchar(250) DEFAULT NULL,
  `customField5` varchar(250) DEFAULT NULL,
